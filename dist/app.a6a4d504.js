...
},{"./svg":"src/svg.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/slides.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.arrLength = this.items.length; //上次被选中的值,记录下来
  },
  computed: {
  ...
  methods: {
    ...
    updateChildern: function updateChildern() {
      ...
      this.items.forEach(function (vm) {
        ...
        if (_this.timeId) {
          if (_this.lastSelected === _this.items.length - 1 && _this.selectedIndex === 0) {
            reverse = false;
          }

          if (_this.lastSelected === 0 && _this.lastSelected === _this.items.length - 1) {
            reverse = true;
          }
        }
    ...
    selectedClick: function selectedClick(index) {
      ...
      this.lastSelected = this.selectedIndex; // console.log(this.lastSelected)
    ...
    playAutopaly: function playAutopaly() {
      ...
      var run = function run() {
        ...
        var newIndex = index + 1; // this.$emit('update:selected',names[newIndex]);
        //告诉外界选中的newIndex
...
exports.default = _default;
        var $90a0a2 = exports.default || module.exports;
      
      if (typeof $90a0a2 === 'function') {
        $90a0a2 = $90a0a2.options;
      }
    
        /* template */
        Object.assign($90a0a2, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$90a0a2', $90a0a2);
          } else {
            api.reload('$90a0a2', $90a0a2);
          }
        }
...
},{"./icon":"src/icon.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/slides-item.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $286e53 = exports.default || module.exports;
      
      if (typeof $286e53 === 'function') {
        $286e53 = $286e53.options;
      }
    
        /* template */
        Object.assign($286e53, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$286e53', $286e53);
          } else {
            api.reload('$286e53', $286e53);
          }
        }
...
var _slidesItem = _interopRequireDefault(require("./slides-item"));
...
var _default = {
  ...
  components: {
    slidesItem: _slidesItem.default,
...
},{"./slides":"src/slides.vue","./slides-item":"src/slides-item.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/app.js":[function(require,module,exports) {
"use strict";
