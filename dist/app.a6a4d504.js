...
!function (a) {
  ...
  !function (t) {
    ...
    } else document.attachEvent && (c = t, i = a.document, n = !1, (_o = function o() {
      try {
...
_vue.default.component('x-button', _button3.default);
...
{
  //构造函数
  var Constructor = _vue.default.extend(_button3.default); //实例化对象
  ...
  button.$mount('#text');
  console.log(button);
  var uesElement = button.$el.querySelector('use');
  var href = uesElement.getAttribute('xlink:href'); // 断言是#icon-set
...
{
  //构造函数
  var _Constructor = _vue.default.extend(_button3.default); //实例化对象
  ...
  var _uesElement = _button.$el.querySelector('use');

  var _href = _uesElement.getAttribute('xlink:href'); // 断言是#icon-loading
